...
const SAMPLES = [
  {
    label: 'Sample 1',
    img: '/images/gradcam_sample1.png',
    severity: 'No DR',
    confidence: 82.1,
    tier: 'MONITOR',
    color: '#10b981',
  ...
  {
    label: 'Sample 2',
    img: '/images/gradcam_sample2.png',
    severity: 'No DR',
    confidence: 99.6,
    tier: 'MONITOR',
    color: '#10b981',
    summary: 'High-confidence classification. Retinal vasculature entirely healthy with no pathological features detected across any quadrant.',
    action: 'Routine annual screening sufficient. No further clinical escalation required at this time.',
    hcp: 'Automated patient portal notification. No HCP intervention needed.',
    channel: 'Digital',
  },
  {
    label: 'Sample 3',
    img: '/images/gradcam_sample3.png',
